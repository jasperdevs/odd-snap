...
- GPUI can persist sticker provider, local model, CPU/GPU execution, stroke, and shadow settings back to the migrated sticker settings JSON.
- GPUI can persist upscale provider, local model, CPU/GPU execution, scale factor, and preview-window preference back to the migrated upscale settings JSON.
