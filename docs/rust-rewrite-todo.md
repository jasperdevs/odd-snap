...
- [ ] macOS Vision OCR, language discovery/install status, result window, translation polish, sound/toast polish, and production cleanup.
- [ ] Translation.
...
- [ ] Background OCR refresh worker and reindex progress UI.
