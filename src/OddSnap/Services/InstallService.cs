...
public static class InstallService
{
    ...
    private static void RegisterApp(string installDir, string exePath, string? versionLabel = null)
    {
        try
        {
            ...
            key.SetValue("URLInfoAbout", "https://github.com/jasperdevs/odd-snap");
            key.SetValue("URLUpdateInfo", "https://github.com/jasperdevs/odd-snap/releases/latest");
            key.SetValue("HelpLink", "https://github.com/jasperdevs/odd-snap/issues");
