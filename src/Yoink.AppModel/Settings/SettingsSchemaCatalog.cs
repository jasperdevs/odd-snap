namespace Yoink.AppModel.Settings;
        ...
        new(
            ...
            [
                ...
                new SettingsSectionDefinition(
                    ...
                    [
                        new SettingDefinition("start_with_windows", "Start with Windows", SettingsValueKind.Toggle, "Launch Yoink automatically when the user signs in.", "StartWithWindows"),
